...
- **Timestamp:** `2026-09-01T07:09:11.172972+00:00`
- **Total Transitions:** `14`
- **Total Execution Latency:** `14948.30 ms`
...
- **Timestamp:** `2026-09-01T07:08:52.553419+00:00` | **Latency:** `2.43 ms`
...
- **Timestamp:** `2026-09-01T07:08:52.558070+00:00` | **Latency:** `4349.57 ms`
- **Detected Intent:** `booking`
- **Agent Reasoning:** Successfully booked appointment appt_8c218de9cb in UrduLish.
...
- **Output Summary:**
  ...
  "clarification_needed": false,
  "validation_errors": [],
  "final_response_snippet": "Zabardast Hamza Ali sahib! Aap ka visit House in Lahore ke liye 2027-01-13 3:00 PM par confirm schedule ho gaya hai. Hamare consultant Ahmed Raza aap ko site par receive karenge. A..."
}
  ```

### Step 3: Node `IntentDetectionNode` (from `START`)
- **Timestamp:** `2026-09-01T07:08:56.911990+00:00` | **Latency:** `0.27 ms`
- **Detected Intent:** `greeting`
...
- **Timestamp:** `2026-09-01T07:08:56.913738+00:00` | **Latency:** `0.03 ms`
- **Detected Intent:** `greeting`
...
- **Timestamp:** `2026-09-01T07:08:56.915832+00:00` | **Latency:** `0.13 ms`
- **Detected Intent:** `greeting`
...
- **Timestamp:** `2026-09-01T07:08:56.916887+00:00` | **Latency:** `2219.92 ms`
- **Detected Intent:** `rag`
...
- **Timestamp:** `2026-09-01T07:08:59.148967+00:00` | **Latency:** `0.12 ms`
- **Detected Intent:** `greeting`
...
- **Timestamp:** `2026-09-01T07:08:59.149570+00:00` | **Latency:** `310.84 ms`
...
- **Timestamp:** `2026-09-01T07:08:59.463539+00:00` | **Latency:** `0.12 ms`
- **Detected Intent:** `greeting`
...
- **Timestamp:** `2026-09-01T07:08:59.464611+00:00` | **Latency:** `4286.3 ms`
...
- **Output Summary:**
  ...
  "clarification_needed": false,
  "validation_errors": [],
  "final_response_snippet": "Zabardast ji! Aap ka visit 5 Marla House ke liye successfully 2027-12-15 11:00 AM par reschedule kar diya gaya hai. Consultant Ahmed Raza ko bhi update send kar di gayi hai."
}
  ```

### Step 11: Node `IntentDetectionNode` (from `ReschedulingNode`)
- **Timestamp:** `2026-09-01T07:09:03.754033+00:00` | **Latency:** `0.1 ms`
- **Detected Intent:** `rescheduling`
...
- **Timestamp:** `2026-09-01T07:09:03.756932+00:00` | **Latency:** `3778.25 ms`
...
- **Timestamp:** `2026-09-01T07:09:11.169011+00:00` | **Latency:** `0.15 ms`
- **Detected Intent:** `greeting`
...
- **Timestamp:** `2026-09-01T07:09:11.171779+00:00` | **Latency:** `0.07 ms`
- **Detected Intent:** `recommendation`
