...
- **Timestamp:** `2026-09-06T14:48:13.403663+00:00`
- **Total Transitions:** `14`
- **Total Execution Latency:** `18740.46 ms`
...
- **Timestamp:** `2026-09-06T14:47:49.756576+00:00` | **Latency:** `1.89 ms`
...
- **Timestamp:** `2026-09-06T14:47:49.760596+00:00` | **Latency:** `3705.38 ms`
- **Detected Intent:** `booking`
- **Agent Reasoning:** Successfully booked appointment APT-9982 in UrduLish.
...
- **Output Summary:**
  ...
  "clarification_needed": false,
  "validation_errors": [],
  "final_response_snippet": "Zabardast Hamza Ali sahib! Aap ka visit House in Lahore ke liye 2027-04-17 3:00 PM par confirm schedule ho gaya hai. Aap ka Appointment ID APT-9982 hai. Yeh ID aap ko confirmation ..."
}
  ```

### Step 3: Node `IntentDetectionNode` (from `START`)
- **Timestamp:** `2026-09-06T14:47:53.471263+00:00` | **Latency:** `0.46 ms`
- **Detected Intent:** `greeting`
...
- **Timestamp:** `2026-09-06T14:47:53.473191+00:00` | **Latency:** `0.04 ms`
- **Detected Intent:** `greeting`
...
- **Timestamp:** `2026-09-06T14:47:53.476961+00:00` | **Latency:** `0.27 ms`
- **Detected Intent:** `greeting`
...
- **Timestamp:** `2026-09-06T14:47:53.479409+00:00` | **Latency:** `3986.3 ms`
- **Detected Intent:** `rag`
...
- **Output Summary:**
  ...
  "clarification_needed": false,
  "validation_errors": [],
  "final_response_snippet": "Bahria Town mein aapko community park, gymnasium, swimming pool aur wide carpeted roads jaisi behtareen amenities milti hain. Payment plan ki yeh specific maloomat hamare verified ..."
}
  ```

### Step 7: Node `IntentDetectionNode` (from `START`)
- **Timestamp:** `2026-09-06T14:47:57.478385+00:00` | **Latency:** `1616.27 ms`
- **Detected Intent:** `greeting`
...
- **Timestamp:** `2026-09-06T14:47:59.096404+00:00` | **Latency:** `260.5 ms`
...
- **Timestamp:** `2026-09-06T14:47:59.361904+00:00` | **Latency:** `47.07 ms`
- **Detected Intent:** `greeting`
...
- **Timestamp:** `2026-09-06T14:47:59.410717+00:00` | **Latency:** `4277.79 ms`
...
- **Output Summary:**
  ...
  "clarification_needed": false,
  "validation_errors": [],
  "final_response_snippet": "Zabardast ji! Appointment ID appt_test_14f55c (5 Marla House) ke liye successfully 2027-12-16 1:00 PM par reschedule kar diya gaya hai. Updated confirmation email aap ko aur consul..."
}
  ```

### Step 11: Node `IntentDetectionNode` (from `ReschedulingNode`)
- **Timestamp:** `2026-09-06T14:48:03.693279+00:00` | **Latency:** `40.67 ms`
- **Detected Intent:** `rescheduling`
...
- **Timestamp:** `2026-09-06T14:48:03.735706+00:00` | **Latency:** `4801.31 ms`
...
- **Output Summary:**
  ...
  "clarification_needed": false,
  "validation_errors": [],
  "final_response_snippet": "Zaroor ji, Appointment ID appt_test_14f55c (5 Marla House) kamyabi se cancel kar di gayi hai aur confirmation email bhej di gayi hai. Jab bhi aap dobara visit plan karein, zaroor b..."
}
  ```

### Step 13: Node `IntentDetectionNode` (from `START`)
- **Timestamp:** `2026-09-06T14:48:13.397124+00:00` | **Latency:** `2.44 ms`
- **Detected Intent:** `greeting`
...
- **Timestamp:** `2026-09-06T14:48:13.401459+00:00` | **Latency:** `0.07 ms`
- **Detected Intent:** `recommendation`
