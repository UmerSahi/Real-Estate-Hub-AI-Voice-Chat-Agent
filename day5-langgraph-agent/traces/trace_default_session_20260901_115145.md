...
- **Timestamp:** `2026-09-01T06:51:45.966886+00:00`
- **Total Transitions:** `14`
- **Total Execution Latency:** `13650.25 ms`
...
- **Timestamp:** `2026-09-01T06:51:28.689933+00:00` | **Latency:** `1.74 ms`
- **Detected Intent:** `greeting`
- **Agent Reasoning:** Intent: 'booking'. Time: '3:00 PM'. Name: 'Hamza Ali'. Clarification: False.
...
- **Timestamp:** `2026-09-01T06:51:28.692449+00:00` | **Latency:** `3643.94 ms`
- **Detected Intent:** `booking`
- **Agent Reasoning:** Successfully booked appointment appt_c4bbee6675 in UrduLish.
...
- **Output Summary:**
  ...
  "clarification_needed": false,
  "validation_errors": [],
  "final_response_snippet": "Zabardast Hamza Ali sahib! Aap ka visit House in Lahore ke liye 2027-06-24 3:00 PM par confirm schedule ho gaya hai. Hamare consultant Ahmed Raza aap ko site par receive karenge. A..."
}
  ```

### Step 3: Node `IntentDetectionNode` (from `START`)
- **Timestamp:** `2026-09-01T06:51:32.341944+00:00` | **Latency:** `0.34 ms`
- **Detected Intent:** `greeting`
- **Agent Reasoning:** Intent: 'greeting'. Time: ''. Name: ''. Clarification: False.
- **Tools Invocations:** None
- **Validation Checks:**
  > Standard Invariants Verified
- **Output Summary:**
...
- **Timestamp:** `2026-09-01T06:51:32.343580+00:00` | **Latency:** `0.04 ms`
- **Detected Intent:** `greeting`
...
- **Timestamp:** `2026-09-01T06:51:32.346673+00:00` | **Latency:** `0.13 ms`
- **Detected Intent:** `greeting`
- **Agent Reasoning:** Intent: 'rag'. Time: ''. Name: ''. Clarification: False.
- **Tools Invocations:** None
- **Validation Checks:**
  > Standard Invariants Verified
- **Output Summary:**
...
- **Timestamp:** `2026-09-01T06:51:32.347175+00:00` | **Latency:** `2509.78 ms`
- **Detected Intent:** `rag`
...
- **Output Summary:**
  ...
  "clarification_needed": false,
  "validation_errors": [],
  "final_response_snippet": "Yeh specific maloomat hamare verified record mein mojood nahi hai, lekin main consultant se rabta karwa sakta hoon. Aap apna number share kar dein taake woh aapko mazeed detail bat..."
}
  ```

### Step 7: Node `IntentDetectionNode` (from `START`)
- **Timestamp:** `2026-09-01T06:51:34.872758+00:00` | **Latency:** `0.18 ms`
- **Detected Intent:** `greeting`
- **Agent Reasoning:** Intent: 'recommendation'. Time: ''. Name: ''. Clarification: False.
- **Tools Invocations:** None
- **Validation Checks:**
  > Standard Invariants Verified
- **Output Summary:**
...
- **Timestamp:** `2026-09-01T06:51:34.874002+00:00` | **Latency:** `329.55 ms`
...
- **Timestamp:** `2026-09-01T06:51:35.207571+00:00` | **Latency:** `0.15 ms`
- **Detected Intent:** `greeting`
- **Agent Reasoning:** Intent: 'rescheduling'. Time: '11:00 AM'. Name: ''. Clarification: False.
- **Tools Invocations:** None
- **Validation Checks:**
  > Standard Invariants Verified
- **Output Summary:**
...
- **Timestamp:** `2026-09-01T06:51:35.209257+00:00` | **Latency:** `3714.66 ms`
...
- **Output Summary:**
  ...
  "clarification_needed": false,
  "validation_errors": [],
  "final_response_snippet": "Aap ka visit **5 Marla House** ke liye successfully **2027-12-16 11:00 AM** par reschedule kar diya gaya hai. Consultant Ahmed Raza ko bhi update send kar di gayi hai."
}
  ```

### Step 11: Node `IntentDetectionNode` (from `ReschedulingNode`)
- **Timestamp:** `2026-09-01T06:51:38.928346+00:00` | **Latency:** `0.13 ms`
- **Detected Intent:** `rescheduling`
- **Agent Reasoning:** Intent: 'cancellation'. Time: '11:00 AM'. Name: ''. Clarification: False.
- **Tools Invocations:** None
- **Validation Checks:**
  > Standard Invariants Verified
- **Output Summary:**
...
- **Timestamp:** `2026-09-01T06:51:38.929707+00:00` | **Latency:** `3449.38 ms`
...
- **Timestamp:** `2026-09-01T06:51:45.963294+00:00` | **Latency:** `0.16 ms`
- **Detected Intent:** `greeting`
- **Agent Reasoning:** Intent: 'recommendation'. Time: ''. Name: ''. Clarification: True.
- **Tools Invocations:** None
- **Validation Checks:**
  > Standard Invariants Verified
- **Output Summary:**
...
- **Timestamp:** `2026-09-01T06:51:45.965113+00:00` | **Latency:** `0.07 ms`
- **Detected Intent:** `recommendation`
- **Agent Reasoning:** Requested clarification from user in UrduLish.
- **Tools Invocations:** None
- **Validation Checks:**
  > [PASSED] **Clarification Safeguard**: Prompted user for clarification in UrduLish: 'Aap کس city mein dekhna chahenge? Hamare paas Lahore, Islamabad aur Rawalpindi mein options available hain.'
- **Output Summary:**
  ```json
  {
  "budget": null,
  ...
  "clarification_needed": false,
  "validation_errors": [],
  "final_response_snippet": "Aap \u06a9\u0633 city mein dekhna chahenge? Hamare paas Lahore, Islamabad aur Rawalpindi mein options available hain."
}
  ```
