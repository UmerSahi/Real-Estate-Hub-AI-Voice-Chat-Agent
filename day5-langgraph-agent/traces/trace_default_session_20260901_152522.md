...
- **Timestamp:** `2026-09-01T10:25:22.273887+00:00`
- **Total Transitions:** `14`
- **Total Execution Latency:** `14431.22 ms`
...
- **Timestamp:** `2026-09-01T10:25:04.444328+00:00` | **Latency:** `2.44 ms`
...
- **Timestamp:** `2026-09-01T10:25:04.448910+00:00` | **Latency:** `3865.17 ms`
- **Detected Intent:** `booking`
- **Agent Reasoning:** Successfully booked appointment appt_49b1e31a24 in UrduLish.
...
- **Output Summary:**
  ...
  "clarification_needed": false,
  "validation_errors": [],
  "final_response_snippet": "Zabardast Hamza Ali sahib! Aap ka visit House in Lahore ke liye 2027-08-10 3:00 PM par confirm schedule ho gaya hai. Hamare consultant Ahmed Raza aap ko site par receive karenge. A..."
}
  ```

### Step 3: Node `IntentDetectionNode` (from `START`)
- **Timestamp:** `2026-09-01T10:25:08.322158+00:00` | **Latency:** `0.87 ms`
- **Detected Intent:** `greeting`
...
- **Timestamp:** `2026-09-01T10:25:08.327112+00:00` | **Latency:** `0.07 ms`
- **Detected Intent:** `greeting`
...
- **Timestamp:** `2026-09-01T10:25:08.332311+00:00` | **Latency:** `0.3 ms`
- **Detected Intent:** `greeting`
...
- **Timestamp:** `2026-09-01T10:25:08.333405+00:00` | **Latency:** `3035.78 ms`
- **Detected Intent:** `rag`
...
- **Output Summary:**
  ...
  "clarification_needed": false,
  "validation_errors": [],
  "final_response_snippet": "Bahria mein aap ko community park, swimming pool, underground electricity aur wide carpeted roads jaisi behtareen sahooliyat milti hain. Payment plan ki yeh specific maloomat hamar..."
}
  ```

### Step 7: Node `IntentDetectionNode` (from `START`)
- **Timestamp:** `2026-09-01T10:25:11.389316+00:00` | **Latency:** `0.31 ms`
- **Detected Intent:** `greeting`
...
- **Timestamp:** `2026-09-01T10:25:11.391032+00:00` | **Latency:** `547.33 ms`
...
- **Timestamp:** `2026-09-01T10:25:11.944427+00:00` | **Latency:** `0.19 ms`
- **Detected Intent:** `greeting`
...
- **Timestamp:** `2026-09-01T10:25:11.946005+00:00` | **Latency:** `3956.5 ms`
...
- **Output Summary:**
  ...
  "clarification_needed": false,
  "validation_errors": [],
  "final_response_snippet": "Zabardast ji! Aap ka visit 5 Marla House ke liye successfully 2027-12-23 1:00 PM par reschedule kar diya gaya hai. Consultant Ahmed Raza ko bhi update send kar di gayi hai."
}
  ```

### Step 11: Node `IntentDetectionNode` (from `ReschedulingNode`)
- **Timestamp:** `2026-09-01T10:25:15.911673+00:00` | **Latency:** `0.31 ms`
- **Detected Intent:** `rescheduling`
...
- **Timestamp:** `2026-09-01T10:25:15.915114+00:00` | **Latency:** `3021.57 ms`
...
- **Timestamp:** `2026-09-01T10:25:22.270315+00:00` | **Latency:** `0.32 ms`
- **Detected Intent:** `greeting`
...
- **Timestamp:** `2026-09-01T10:25:22.271701+00:00` | **Latency:** `0.06 ms`
- **Detected Intent:** `recommendation`
