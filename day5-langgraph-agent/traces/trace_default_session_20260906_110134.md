...
- **Timestamp:** `2026-09-06T06:01:34.580261+00:00`
- **Total Transitions:** `14`
- **Total Execution Latency:** `16253.88 ms`
...
- **Timestamp:** `2026-09-06T06:01:13.781645+00:00` | **Latency:** `1.15 ms`
...
- **Timestamp:** `2026-09-06T06:01:13.784808+00:00` | **Latency:** `4520.44 ms`
- **Detected Intent:** `booking`
- **Agent Reasoning:** Successfully booked appointment appt_34d0676421 in UrduLish.
...
- **Output Summary:**
  ...
  "clarification_needed": false,
  "validation_errors": [],
  "final_response_snippet": "Zabardast Hamza Ali sahib! Aap ka visit House in Lahore ke liye 2027-04-13 3:00 PM par confirm schedule ho gaya hai. Hamare consultant Ahmed Raza aap ko site par receive karenge. A..."
}
  ```

### Step 3: Node `IntentDetectionNode` (from `START`)
- **Timestamp:** `2026-09-06T06:01:18.308994+00:00` | **Latency:** `0.28 ms`
- **Detected Intent:** `greeting`
...
- **Timestamp:** `2026-09-06T06:01:18.310596+00:00` | **Latency:** `0.03 ms`
- **Detected Intent:** `greeting`
...
- **Timestamp:** `2026-09-06T06:01:18.316006+00:00` | **Latency:** `0.21 ms`
- **Detected Intent:** `greeting`
...
- **Timestamp:** `2026-09-06T06:01:18.318690+00:00` | **Latency:** `3211.36 ms`
- **Detected Intent:** `rag`
...
- **Output Summary:**
  ...
  "clarification_needed": false,
  "validation_errors": [],
  "final_response_snippet": "Bahria Town mein aapko community park, underground electricity, wide carpeted roads aur swimming pool jaisi behtareen amenities milti hain. Jahan tak payment plan ka talluq hai, ye..."
}
  ```

### Step 7: Node `IntentDetectionNode` (from `START`)
- **Timestamp:** `2026-09-06T06:01:21.542794+00:00` | **Latency:** `1028.54 ms`
- **Detected Intent:** `greeting`
...
- **Timestamp:** `2026-09-06T06:01:22.574155+00:00` | **Latency:** `213.94 ms`
...
- **Timestamp:** `2026-09-06T06:01:22.791628+00:00` | **Latency:** `0.12 ms`
- **Detected Intent:** `greeting`
...
- **Timestamp:** `2026-09-06T06:01:22.793179+00:00` | **Latency:** `3758.12 ms`
...
- **Output Summary:**
  ...
  "clarification_needed": false,
  "validation_errors": [],
  "final_response_snippet": "Zabardast ji! Aap ka visit 5 Marla House ke liye successfully 2027-12-24 1:00 PM par reschedule kar diya gaya hai. Consultant Ahmed Raza ko bhi update send kar di gayi hai."
}
  ```

### Step 11: Node `IntentDetectionNode` (from `ReschedulingNode`)
- **Timestamp:** `2026-09-06T06:01:26.555438+00:00` | **Latency:** `0.12 ms`
- **Detected Intent:** `rescheduling`
...
- **Timestamp:** `2026-09-06T06:01:26.558262+00:00` | **Latency:** `3516.72 ms`
...
- **Timestamp:** `2026-09-06T06:01:34.573460+00:00` | **Latency:** `2.8 ms`
- **Detected Intent:** `greeting`
...
- **Timestamp:** `2026-09-06T06:01:34.578104+00:00` | **Latency:** `0.05 ms`
- **Detected Intent:** `recommendation`
